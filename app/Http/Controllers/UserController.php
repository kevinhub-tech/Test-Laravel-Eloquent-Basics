...
class UserController extends Controller
{
    ...
    public function check_create($name, $email)
    {
        ...
        if (!$user) {
            $user = User::create(['name' => $name, 'email' => $email, 'password' => Hash::make(Str::password())]);
        }
    ...
    public function check_update($name, $email)
    {
        ...
        //   if not found, create a user with $name, $email and random password
        $user = User::updateOrCreate(['name' => $name, 'email' => $email], ['name' => $name, 'email' => $email, 'password' => Hash::make(Str::password())]); // updated or created user
